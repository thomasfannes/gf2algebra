...
static const unsigned char E[GF256::ORDER] =
...
const GF256 GF256::zero = GF256(0);
...
std::string GF256::polyRepresentation() const
{
	std::stringstream str;
	bool first = true;

    for (int i = static_cast<int>(POWER) - 1; i >= 0; i--)
    {
        if (_m & (1 << i))
        {
			if (first)
